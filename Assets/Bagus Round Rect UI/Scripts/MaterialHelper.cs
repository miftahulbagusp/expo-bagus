...
namespace UnityEngine.UI.ProceduralImage
{
	public class MaterialHelper {
		...
		public static Material SetMaterialValues(ProceduralImageMaterialInfo info,Material baseMaterial){
			...
			if (baseMaterial.shader.name != "Atlas/UI/Round Rect UI") {
				Debug.LogWarning("Parameter 'baseMaterial' does not use shader 'Atlas/UI/Round Rect UI'. Method returns baseMaterial.");
				return baseMaterial;
			}
			Material m;
			m = baseMaterial; 
